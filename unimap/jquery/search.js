$(document).ready(function(){
	$.getJSON("actions.php?action=search&term="+get, function(json){
		...
		$(json["disciplines"]).each(function(){
			console.log($(this));
			$("#results").append("<a class='discipline' data-toggle='modal' data-target='#modalPesquisa' href='javascript:void(0);' id='"+$(this)[0]["cod_disc"]+"'>"+$(this)[0]["name"]+"</a><br>");
		});
		$("#results").append("<hr>Professores<hr>");
		$(json["teachers"]).each(function(){
			console.log($(this));
			$("#results").append("<a class='teacher' data-toggle='modal' data-target='#modalPesquisa' href='javascript:void(0);' id='"+$(this)[0]["id"]+"'>"+$(this)[0]["name"]+"</a><br>");
		});
	});
	...
	$('.teacher').click(function(){
		...
		$.getJSON("actions.php?action=showTeacherSchedule&teacher="+x, function(json){
